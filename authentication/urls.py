from .views import CompletePasswordReset, RegistrationView, ResetPassword, UsernameValidationView, EmailValidationView, LogoutView, VerificationView, LoginView
...
urlpatterns = [
    ...
    path("request_password",ResetPassword.as_view(),name='request_password'),
